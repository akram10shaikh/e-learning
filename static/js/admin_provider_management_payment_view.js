const courses = [
    {ivoice: "#16879", name: 'John Dye', month: "Mar, 2023", course: 'Artificial Intelligence', no_of_enrollments: '500 Users',per_share: '$30',amount: '$35', proof : "View Proof", bill:"View Bill"},
    {ivoice: "#16879", name: 'John Dye', month: "Mar, 2023", course: 'Artificial Intelligence', no_of_enrollments: '500 Users',per_share: '$30',amount: '$35', proof : "View Proof", bill:"View Bill"},
    {ivoice: "#16879", name: 'John Dye', month: "Mar, 2023", course: 'Artificial Intelligence', no_of_enrollments: '500 Users',per_share: '$30',amount: '$35', proof : "View Proof", bill:"View Bill"},
    {ivoice: "#16879", name: 'John Dye', month: "Mar, 2023", course: 'Artificial Intelligence', no_of_enrollments: '500 Users',per_share: '$30',amount: '$35', proof : "View Proof", bill:"View Bill"},
    {ivoice: "#16879", name: 'John Dye', month: "Mar, 2023", course: 'Artificial Intelligence', no_of_enrollments: '500 Users',per_share: '$30',amount: '$35', proof : "View Proof", bill:"View Bill"},
...
function renderTable() {
    ...
    for (let i = start; i < end; i++) {
        ...
        row.innerHTML = `
            ...
            <td>${courses[i].no_of_enrollments}</td>
            <td>${courses[i].per_share}</td>
            <td>${courses[i].amount}</td>
            <td class="status"><p class="green-status">${courses[i].proof}</p></td>
